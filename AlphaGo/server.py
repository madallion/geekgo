...
def init_cnnpolicynetwork():
    ...
    weights_file = os.path.join(train_folder, 'weights.lee1game.hdf5')
    #weights_file = os.path.join(train_folder, 'models_continueSLon9thEpoch_20160501_11thEpoch.hdf5')
